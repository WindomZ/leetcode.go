...
func Test_findMedianSortedArrays(t *testing.T) {
	...
	assert.Equal(t, float64(3), findMedianSortedArrays([]int{2}, []int{1, 3, 4, 5}))
	assert.Equal(t, float64(3), findMedianSortedArrays([]int{3}, []int{1, 2, 4, 5}))
	assert.Equal(t, float64(3), findMedianSortedArrays([]int{4}, []int{1, 2, 3, 5}))
	assert.Equal(t, float64(3), findMedianSortedArrays([]int{5}, []int{1, 2, 3, 4}))
	assert.Equal(t, float64(3), findMedianSortedArrays([]int{1, 2}, []int{3, 4, 5}))
	assert.Equal(t, float64(3), findMedianSortedArrays([]int{1, 2, 3}, []int{4, 5}))
	assert.Equal(t, float64(3), findMedianSortedArrays([]int{1, 2, 3, 4}, []int{5}))
	assert.Equal(t, float64(3), findMedianSortedArrays([]int{1, 2, 3, 5}, []int{4}))
	assert.Equal(t, float64(3), findMedianSortedArrays([]int{1, 2, 4, 5}, []int{3}))
	assert.Equal(t, float64(3), findMedianSortedArrays([]int{1, 3, 4, 5}, []int{2}))
	assert.Equal(t, float64(3), findMedianSortedArrays([]int{2, 3, 4, 5}, []int{1}))

	assert.Equal(t, float64(3.5), findMedianSortedArrays([]int{1}, []int{2, 3, 4, 5, 6}))
	assert.Equal(t, float64(3.5), findMedianSortedArrays([]int{2}, []int{1, 3, 4, 5, 6}))
	assert.Equal(t, float64(3.5), findMedianSortedArrays([]int{3}, []int{1, 2, 4, 5, 6}))
	assert.Equal(t, float64(3.5), findMedianSortedArrays([]int{4}, []int{1, 2, 3, 5, 6}))
	assert.Equal(t, float64(3.5), findMedianSortedArrays([]int{5}, []int{1, 2, 3, 4, 6}))
	assert.Equal(t, float64(3.5), findMedianSortedArrays([]int{6}, []int{1, 2, 3, 4, 5}))
	assert.Equal(t, float64(3.5), findMedianSortedArrays([]int{1, 2}, []int{3, 4, 5, 6}))
	assert.Equal(t, float64(3.5), findMedianSortedArrays([]int{1, 2, 3, 4, 5}, []int{6}))
	assert.Equal(t, float64(3.5), findMedianSortedArrays([]int{1, 2, 3, 4, 6}, []int{5}))
	assert.Equal(t, float64(3.5), findMedianSortedArrays([]int{1, 2, 3, 5, 6}, []int{4}))
	assert.Equal(t, float64(3.5), findMedianSortedArrays([]int{1, 2, 4, 5, 6}, []int{3}))
	assert.Equal(t, float64(3.5), findMedianSortedArrays([]int{1, 3, 4, 5, 6}, []int{2}))
	assert.Equal(t, float64(3.5), findMedianSortedArrays([]int{2, 3, 4, 5, 6}, []int{1}))
	assert.Equal(t, float64(3.5), findMedianSortedArrays([]int{3, 4, 5, 6}, []int{1, 2}))
